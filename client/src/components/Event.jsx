...
export default function EventsSection() {
  ...
  return (
    <section className="events" id="events">
      ...
      <h2 className="section-heading"><span className="line"></span>Technical Events</h2>
      ...
      <h2 className="section-heading"><span className="line"></span>Non-Technical Events</h2>
